...
# resources
some_engine = create_engine('mysql+mysqlconnector://root:saw99@localhost/NDMC_Streets')
...
#___________________TOTAL TREES MAPPED____________
    ...
    #max_count = session.query(func.max(Specie_Database.count))
    #print"\n______________________________********T&^%&^%@__________",max_count
    ...
    print"\n_______________________________****&*&*^&%^$%^_____________",max(testCount)
    ...
    for x in most_common_species:
        print"\n____________________",x.specie," ",x.count
