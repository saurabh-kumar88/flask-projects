...
# test code for________Pagination________
...
#---------------test code----------
@street.route('/map_rotation')
def map_rotation():
    return render_template('street/map-rotation.html')
...
#_____________________SEARCH BY ID CODE______________________
        ...
        for k in street_names.keys():
            ...
            if exists:
                ...
                for x in tree_data:
                    ...
                    image_1 = "static/images/tree-images/" + str(specie)+ ".jpg"
                    image_2 = "static/images/tree-images/" + str(specie)+ "2.jpg"
                    print"\n_________________image_1",image_1
...
#---------------test code (SERVER-SIDE PAGINATION)-----------
...
def view(page):
    ...
    Street = request.args.get('my_var', None)
    table_name = street_names.get(str(Street))
    posts = RK_Ashram_Marg.query.paginate(page,per_page,error_out=False) #SQLALCHEMY query for pagination
...
#_________________test code___________________
