...
class Aurangzeb_Lane_Saplings(db.Model):
...
@event.listens_for(Aurangzeb_Lane_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
@event.listens_for(Aurangzeb_Lane_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Aurangzeb_Lane_Saplings_growth_data(db.Model):
...
class Jashwant_singh_Road_Saplings(db.Model):
...
@event.listens_for(Jashwant_singh_Road_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
@event.listens_for(Jashwant_singh_Road_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Jashwant_singh_Road_Saplings_growth_data(db.Model):
...
@event.listens_for(Jai_singh_Road, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.specie_code
...
@event.listens_for(Jai_singh_Road, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.specie_code
...
class Jai_singh_Road_Saplings(db.Model):
...
@event.listens_for(Jai_singh_Road_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
@event.listens_for(Jai_singh_Road_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Jai_singh_Road_Saplings_growth_data(db.Model):
...
@event.listens_for(Mandir_Marg, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.specie_code
...
@event.listens_for(Mandir_Marg, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.specie_code
...
class Mandir_Marg_Saplings(db.Model):
...
@event.listens_for(Mandir_Marg_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
@event.listens_for(Mandir_Marg_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Mandir_Marg_Saplings_growth_data(db.Model):
...
class Abdul_Fazal_Road_Saplings(db.Model):
...
@event.listens_for(Abdul_Fazal_Road_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
@event.listens_for(Abdul_Fazal_Road_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Abdul_Fazal_Road_Saplings_growth_data(db.Model):
...
class Arch_Bishop_Marg_Saplings(db.Model):
...
@event.listens_for(Arch_Bishop_Marg_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
@event.listens_for(Arch_Bishop_Marg_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Arch_Bishop_Marg_Saplings_growth_data(db.Model):
...
class Aurobindo_Marg_Saplings(db.Model):
...
@event.listens_for(Aurobindo_Marg_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))

@event.listens_for(Aurobindo_Marg_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Aurobindo_Marg_Saplings_growth_data(db.Model):
...
class Sardar_Patel_Marg_Saplings(db.Model):
...
@event.listens_for(Sardar_Patel_Marg_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
@event.listens_for(Sardar_Patel_Marg_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Sardar_Patel_Marg_Saplings_growth_data(db.Model):
...
class Safdarjung_Road_Saplings(db.Model):
...
@event.listens_for(Safdarjung_Road_Saplings, 'before_insert')
def before_insert_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
@event.listens_for(Safdarjung_Road_Saplings, 'before_update')
def before_update_function(mapper, connection, target):
        # 'target' is your object
        target.common_name
        target.sceintific_name = specie_names.get(str(target.common_name))
...
class Safdarjung_Road_Saplings_growth_data(db.Model):
...
#flask ModelView Configuration Attributes
    ...
    column_searchable_list = [Mandir_Marg.Tree_code]
    ...
    form_choices = { 'common_name': [ ('Amaltas', 'Amaltas'),
                                      ...
                                      ('Semal','Semal'),
                                      ('Weeping_bottelbrush', 'Weeping_bottelbrush'),
                                      ('Mango','Mango'),
                                      ('Mulberry','Mulberry'),
                                      ('Royal_palm','Royal_palm'),
                                      ('Maharukh','Maharukh'),
                                      ('Jungle_jalebi','Jungle_jalebi'),
                     ...
                     'condition': [ ('Good/Healthy','Good/Healthy'),
                                    ...
                                    ('Bad/Termite/Sick','Bad/Termite/Sick'),
