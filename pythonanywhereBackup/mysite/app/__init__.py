...
def create_app(config_name):
    ...
    # zone1 streets
    from models import Akbar_Road,Akbar_Road_Saplings,Akbar_Road_Saplings_growth_data

    # zone2 streets
    from models import Aurangzeb_Lane,Aurangzeb_Lane_Saplings,Aurangzeb_Lane_Saplings_growth_data

    # zone3 streets
    from models import Jashwant_singh_Road,Jashwant_singh_Road_Saplings,Jashwant_singh_Road_Saplings_growth_data
    from models import Jai_singh_Road,Jai_singh_Road_Saplings,Jai_singh_Road_Saplings_growth_data
    ...
    from models import Mandir_Marg, Mandir_Marg_Saplings, Mandir_Marg_Saplings_growth_data

    # zone5 streets
    from models import Abdul_Fazal_Road,Abdul_Fazal_Road_Saplings,Abdul_Fazal_Road_Saplings_growth_data

    # zone6 streets
    from models import Arch_Bishop_Marg,Arch_Bishop_Marg_Saplings,Arch_Bishop_Marg_Saplings_growth_data

    # zone7 streets
    from models import Aurobindo_Marg,Aurobindo_Marg_Saplings,Aurobindo_Marg_Saplings_growth_data

    # zone8 streets
    from models import Sardar_Patel_Marg,Sardar_Patel_Marg_Saplings,Sardar_Patel_Marg_Saplings_growth_data

    # zone9 streets
    from models import Safdarjung_Road,Safdarjung_Road_Saplings,Safdarjung_Road_Saplings_growth_data
    ...
    admin.add_view(MyModelView(Akbar_Road_Saplings, db.session, category="Zone1"))
    admin.add_view(MyModelView(Akbar_Road_Saplings_growth_data, db.session, category="Zone1"))

    #-----------Zone2---------
    admin.add_view(MyModelView(Aurangzeb_Lane, db.session, category="Zone2"))
    admin.add_view(MyModelView(Aurangzeb_Lane_Saplings, db.session, category="Zone2"))
    admin.add_view(MyModelView(Aurangzeb_Lane_Saplings_growth_data, db.session, category="Zone2"))

    #-----------Zone3---------
    admin.add_view(MyModelView(Jashwant_singh_Road, db.session, category="Zone3"))
    admin.add_view(MyModelView(Jashwant_singh_Road_Saplings, db.session, category="Zone3"))
    admin.add_view(MyModelView(Jashwant_singh_Road_Saplings_growth_data, db.session, category="Zone3"))

    admin.add_view(MyModelView(Jai_singh_Road, db.session, category="Zone3"))
    admin.add_view(MyModelView(Jai_singh_Road_Saplings, db.session, category="Zone3"))
    admin.add_view(MyModelView(Jai_singh_Road_Saplings_growth_data, db.session, category="Zone3"))
    ...
    admin.add_view(MyModelView(Mandir_Marg, db.session, category="Zone4"))
    admin.add_view(MyModelView(Mandir_Marg_Saplings, db.session, category="Zone4"))
    admin.add_view(MyModelView(Mandir_Marg_Saplings_growth_data, db.session, category="Zone4"))

    #-----------Zone5---------
    admin.add_view(MyModelView(Abdul_Fazal_Road, db.session, category="Zone5"))
    admin.add_view(MyModelView(Abdul_Fazal_Road_Saplings, db.session, category="Zone5"))
    admin.add_view(MyModelView(Abdul_Fazal_Road_Saplings_growth_data, db.session, category="Zone5"))


    #-----------Zone6---------
    admin.add_view(MyModelView(Arch_Bishop_Marg, db.session, category="Zone6"))
    admin.add_view(MyModelView(Arch_Bishop_Marg_Saplings, db.session, category="Zone6"))
    admin.add_view(MyModelView(Arch_Bishop_Marg_Saplings_growth_data, db.session, category="Zone6"))


    #-----------Zone7---------
    admin.add_view(MyModelView(Aurobindo_Marg, db.session, category="Zone7"))
    admin.add_view(MyModelView(Aurobindo_Marg_Saplings, db.session, category="Zone7"))
    admin.add_view(MyModelView(Aurobindo_Marg_Saplings_growth_data, db.session, category="Zone7"))

    #-----------Zone8---------
    admin.add_view(MyModelView(Sardar_Patel_Marg, db.session, category="Zone8"))
    admin.add_view(MyModelView(Sardar_Patel_Marg_Saplings, db.session, category="Zone8"))
    admin.add_view(MyModelView(Sardar_Patel_Marg_Saplings_growth_data, db.session, category="Zone8"))

    #-----------Zone9---------
    admin.add_view(MyModelView(Safdarjung_Road, db.session, category="Zone9"))
    admin.add_view(MyModelView(Safdarjung_Road_Saplings, db.session, category="Zone9"))
    admin.add_view(MyModelView(Safdarjung_Road_Saplings_growth_data, db.session, category="Zone9"))
